...
| **Comment style** | Follow the catalog format set at setup time (`$<key>` for JSON, `#.` for PO) | No per-convert override; consistency with the existing catalog matters more. |
