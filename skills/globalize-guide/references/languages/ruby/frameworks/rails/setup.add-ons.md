...
- **If it doesn't exist**, create it:
  ...
  ```
- **If it exists**, append `@.agents/globalize-rules.md` at the end of the file on its own line ("I'll append `@.agents/globalize-rules.md` to your CLAUDE.md so the Rails i18n coding rules auto-load every session"). Do not remove or reorder existing content.
